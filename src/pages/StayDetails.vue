          ...
          <div class="amenities">
            ...
            <li>
              <section class="amenity flex">
                <section class="icon-svg"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
          ...
          <div>
            <div class="reservation-form-header">
              ...
              <div class="rating-review flex"><span class="avg-rating flex font-md">
                ...
                </span><span>•</span><span class="rev-count link font-md">{{ stay.reviews.length }} review</span></div>
            </div>
            <div class="reservation-data">
              <div class="date-picker">
                <div class="date-input"><label>CHECK-IN</label><input class="subtitle" fdprocessedid="b60swf"></div>
                <div class="date-input"><label>CHECKOUT</label><input class="subtitle" fdprocessedid="l3c0t"></div>
              </div>
              <div class="guest-input"><label>GUESTS</label><input class="font-thin" placeholder="1 Adult"
                  fdprocessedid="xr56ac"><svg viewBox="0 0 320 512" width="100" title="angle-down">
                  <path
            ...
            <div class="branded-btn">
              ...
              <div class="cell"></div>
              <div class="cell"></div>
              <div class="content"><button class="action-btn" fdprocessedid="mx0lay"
                  @click="this.$router.push('/confirm')">
                  <div>Check availabilty</div>
                </button></div>
            </div>
          </div>
        </div>
          ...
          <div class="reviews-cpntainer">
            <div class="reviews-list">
              <li>
                ...
                <div class="txt">
                  Host: Davit gave us a warm welcome and treated us kindly from the very beginning. She offered us help,
                  told us what to visit and even put water, milk and orange juice in the fridge! We could have breakfast
                  at her place which was perfect because she has a little sweet balcony!
                  Location: calmly situated in a side street, very near to the Placa Catalunya, the Rambla and the
                  gothic area of Barcelona (very beautiful:) so you have the old cultural center as well as all the
                  restaurants and bars just nearby.
                  House/Room: the appartment is not a huge, but I think you have everything you need (beautiful sitting
                  room, balcony, kitchen) in it. You have to share the appartment with Marian so pay attention and don't
                  be too loud in the evening!!
