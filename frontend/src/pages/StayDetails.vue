    ...
    <section class="stay-details" v-if="stay">
        ...
        <div class="details flex justify-between">
            <div class="name-subtitle flex align-center">
                <div class="rating-review flex align-center" @click="scrollTo('revs')">
                    <svg class="icon-svg" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                    ...
                    <span class="avg-rating font-md"> {{ stay.rate }} </span> ·
            ...
            <div class="save-stay flex btn" @click="addToFavorite(stay)">
                <svg :class="(isFavorite) ? 'red' : 'black'" class="icon-svg" viewBox="0 0 32 32"
            ...
            <div class="more-details">
                <div class="heading flex justify-between">
                    <div class="txt column flex justify-between">
                        ...
                        <div class="capacity-details flex align-center">
                            <span> {{ stay.capacity }} guests</span>
                            <span>·</span>
                            <span>
                                {{ stay.bedrooms }} bedrooms</span>
                            <span>·</span>
                ...
                <div class="divider"></div>
                <div class="summary">
                    <h4 class="subheading">About this place</h4>
                    <div>
                        {{ stay.summary }}
                    </div>
                </div>
                ...
                <div class="amenities">
                    ...
                    <div class="amenities-container">
                        <li class="amenity flex">
                            <svg class="icon-svg-place" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="reviews-container">
                    <div class="reviews-list">
                        ...
                        <li>
                            <div class="title flex">
                                ...
                                <div class="flex column">
                                    ...
                                    <span class="subtitle fs16">March 2023</span>
                                </div>
                            </div>
                        ...
                        <li>
                            <div class="title flex">
                                ...
                                <div class="flex column">
                                    ...
                                    <span class="subtitle fs16">February 2023</span>
                                </div>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="txt">Wow, one of the most fun vacations in life. The location is amazing, the
                                view is stunning,
                        ...
                        <li>
                            <div class="title flex">
                                ...
                                <div class="flex column">
                                    ...
                                    <span class="subtitle fs16">January 2016</span>
                                </div>
                            </div>
                            <div class="txt">Beautiful lovely villa. The view to the sea from the pool is amazing. The
                                place is shining clean and you will find everything you need.
                                We enjoyed a lot staying here and already we are thinking about planning to come back
                                here soon.
                            </div>
                        </li>
                    </div>
